          ...
          {mode === 'nav' ? (
            ...
            >
              <a href="#home" className="flex items-center gap-2 pl-2 pr-1 flex-shrink-0">
                <img src="/assets/logo-200.webp" alt="TechyMk" className="w-7 h-7 rounded-full object-cover flex-shrink-0 aspect-square" />
              </a>
            ...
            <motion.div
              ...
              data-hover
            >
              <img src="/assets/logo-200.webp" alt="TechyMk" className="w-7 h-7 sm:w-8 sm:h-8 rounded-full object-cover flex-shrink-0" />
