        ...
        <AnimatePresence mode="wait">
          {mode === 'nav' ? (
            ...
            <motion.div
              ...
              data-hover
            >
              <img src="assets/favicon.png" alt="TechyMk" className="w-8 h-8 rounded-full object-cover" />
              <span className="text-content-secondary text-[13px] font-medium">Available for freelance works</span>
