...
const projects = [
  ...
  { id: 3, title: 'Leoplast', subtitle: 'Plumbing Manufacturer', Icon: Building2, desc: 'Designing & developing a complete web presence for Tamil Nadu\'s premier plumbing manufacturer with 30 years of industry leadership.', tags: ['Web', 'UI/UX', 'Branding'], gradient: 'from-rose-500 via-pink-600 to-purple-600', featured: true, building: true },
